...
const Index = () => {
    ...
    const tracks: ITrack = [
            ...
            {_id: '2', name: 'Т3', artist: 'иСПОЛНИТЕЛЬ 2', text: "text", listens: 5, audio: 'http://localhost:5000/audio/2afd9228-1471-43f7-8df0-ee77fe2e3709.mp3', picture:"http://localhost:5000/image/59ba8362-dbdb-442e-bcf3-9fe73a312bc8.jpg", comments: []},
